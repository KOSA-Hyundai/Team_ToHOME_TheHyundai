...
<meta http-equiv="X-UA-Compatible" content="IE=chrome">
<meta name="viewport"
	content="width=device-width, iniial-scale=1.0, maximum-scale=1.0, viewport-fit=cover">

<!-- 상품 상세 태그 -->

<title>상품상세&gt;"${productList[0].prodName}"</title>
<%--prod_name --%>
...
<link rel="stylesheet" type="text/css"
	href="/css/main/s-style_v2.min.css">
<script type="text/javascript" src="/js/main/slazy_v2.min.js"></script>

<link rel="stylesheet" type="text/css"
	href="/css/productList/product.min.css">
<script type="text/javascript"
	src="/js/productList/product.min.js?ver=1649653322184"></script>
...
<body>
	...
	<script type="text/javascript"
		src="/js/productList/product.detail.pc.js?ver=1649653322184"></script>
	...
	<div id="wrap" class="product detail">
		...
		<script type="text/javascript"
			src="/js/main/product.search.pc.init.js?ver=14"></script>
				...
				<section class="proinfo-area">
					...
					<div class="propic">
						<div class="propicbig">
							...
							<img data-zoom-image="" src="${productList[0].prodImg}"
								onerror="${productList[0].prodImg}">
					...
					<div class="proinfo">
						<h2>
							<strong>${productList[0].prodName}</strong> <small>${productList[0].prodDetail}<small>
						</h2>
						...
						<div class="price" id="price_section">
							<span class="txt-price"> <strong><em><fmt:formatNumber value="${productList[0].price}" type="number" pattern="###,###" /></em>원</strong>
							</span>
						</div>
						...
						<div class="detailinfo">
							<dl>
								...
								<dt>원산지</dt>
								<dd>${productList[0].origin}</dd>

								<dt>포장타입</dt>
								<dd>${productList[0].packageType}</dd>
								...
								<dd id="deliverySection">
									새벽배송 / 밤 11시까지 결제 시<br> 배송비 3,500원 (5만원 이상 구매 시 무료)<br>
								...
								<dd>
									...
									<div class="optionarea" id="top_optionarea">
										<div class="optionls">
											<div>
												<strong class="txt-ti">${productList[0].prodName} </strong>
												<div class="ea-area">
												...
												<span class="txt-price"><em><fmt:formatNumber value="${productList[0].price}" type="number" pattern="###,###" /></em>원</span>
											</div>
										</div>
									</div>
								</dd>
						...
						<div class="buybutton" id="top_buybutton">
							...
							<p class="txt-total">
								총 금액 <strong><em><fmt:formatNumber value="${productList[0].price}" type="number" pattern="###,###" /></em>원</strong>
							</p>
			...
			<div class="prodetailcont" style="min-height: 339px;">
				...
				<div class="prodetail-area">
					...
					<div class="tab-menu protabs"
						style="position: relative; inset: 40px 40px;">
						<a href="#p_proReview" class="active" style="width: 25%;"><span>리뷰
								<em id="reviewCnt"></em>
						</span></a>
							...
							<table align="center">
								<tr width="200" height="200">
									<td><button type="button"
											class="btn fill black middle btn-confirm"
											onclick="location.href='/HyundaiServlet?command=review_form'";>리뷰
											작성</button></td>
									<td><button type="button"
											class="btn fill black middle btn-confirm"
											onclick="location.href='/HyundaiServlet?command=review_list&prod_id=${productList[0].id}'">리뷰
											조회</button></td>
									<td><button type="button"
											class="btn fill black middle btn-confirm"
											onclick="fnReviewSave();">리뷰 수정</button></td>
									<td><button type="button"
											class="btn fill black middle btn-confirm"
											onclick="fnReviewSave();">리뷰 삭제</button></td>
									</div>
							</table>
							<!-- //tabs -->
							...
							<section id="p_proReview" class="tab-contents proreview">
								...
								<div class="list-top">
									<button type="button" class="btn black btn-review"
										onclick="fnReviewSelectPopupOpen(this, 'A');">리뷰 작성</button>
								</div>

								<!-- 리뷰 리스트 -->
								<div class="review-list">
									<a
										href="/HyundaiServlet?command=product_detail&id=${productVO.id}"></a>
									<c:forEach var="rev" items="${reviewList}">
										<ul>
											<li data-no="" data-wrt-id="" data-ord-no="" data-slitm-cd=""
												data-opt-cd="" data-img-path="" data-contents=""
												data-img-path1="" data-img-path2="" data-img-path3=""
												data-slitm-nm="" data-slitm-desc="" data-atfl-no=""
												data-scrg="">
												<div class="recont">
													<div class="ti">
														<span class="txt-option"> </span> <span class="txt-review">${rev.contents}</span>
													</div>
												</div>
												<div class="info">
													<span class="txt-id"></span> <span class="txt-date">${rev.create_date}</span>
												</div>
											</li>
											<li data-no="" data-wrt-id="" data-ord-no=""
												data-slitm-cd=${productList[0].id } data-opt-cd=""
												data-img-path="" data-contents="" data-img-path1=""
												data-img-path2="" data-img-path3="" data-slitm-nm=""
												data-slitm-desc="" data-atfl-no="" data-scrg="">
    <div class="recont">
        <div class="ti">
        ...
        <div class="info">
            ...
            <span class="txt-date"></span>
											...
											<li data-no="" data-wrt-id="" data-ord-no="" data-slitm-cd=""
												...
												<div class="recont">
													<div class="ti">
														<span class="txt-option"> </span> <span class="txt-review"></span>
													</div>
												</div>
												<div class="info">
													<span class="txt-id"></span> <span class="txt-date"></span>
												</div>
											</li>
											<li data-no="" data-wrt-id="" data-ord-no="" data-slitm-cd=""
												data-opt-cd="" data-img-path="" data-contents=""
												data-img-path1="" data-img-path2="" data-img-path3=""
												data-slitm-nm=${productList[0].prodName } data-slitm-desc=""
												data-atfl-no="" data-scrg="">
    <div class="recont">
        <div class="ti">
            <span class="txt-option">
        ...
        <div class="info">
            ...
            <span class="txt-date"></span>
						...
						<div class="rightarea" id="bottom_rightarea"
							...
							<div class="buybutton">
								<p class="txt-total">
									총 금액 <strong><em>${productList[0].price}</em>원</strong>
								</p>
								<div class="btns">
									<button type="button" class="btn orange bigger btn-buy"
										onclick="fnPopupScaleOpenA(this, '#p_popCartAdd');">장바구니</button>

...
<script>
    function go_save() {
        if (document.formm.oldpw.value == "") {
            ...
            return false;
        } else if (document.formm.oldpw.value != document.formm.nowpw.value) {
            ...
            <div class="innercon">
                ...
                <section class="conarea">
                    ...
                    <form id="join" method="post" name="formm"
                          ...
                          action="HyundaiServlet?command=update">
                        <fieldset class="form-field">
                            ...
                            <dl>
                                ...
                                <dd>
                                    <input type="text" class="input-group" id="email" name="email"
                            ...
                            <dl class="hpointpw">
                                ...
                                <dd>
                                    <input type="password" class="input-group" id="oldpw"
                                           name="oldpw" title="기존 비밀번호 확인 입력" placeholder="기존 비밀번호"/> <input
                                        type="password" class="input-group" id="pw" name="pw"
                                        title="신규 비밀번호 입력" placeholder="신규 비밀번호"/> <input
                                        type="password" class="input-group" id="pwCheck"
                                        name="pwCheck" title="비밀번호 확인 입력" placeholder="비밀번호 확인"/>
                                    <%@ page
                                    ...
                                    <%@ page import="utill.AES128" %>
                                    <%@ page import="utill.Secret" %>
                                    <%@ page import="dto.MemberVO" %>
                                    <%@ page import="java.io.IOException" %>
                                    <%
                                        String url = "member/mypage.jsp";
                                        HttpSession hsession = request.getSession();
                                        MemberVO memberVO = (MemberVO) hsession.getAttribute("loginUser");
                                        String pwd = null;
                                        try {
                                            pwd = new AES128(Secret.USER_INFO_PASSWORD_KEY).decrypt(memberVO.getPw());
                                    ...
                                    %>
                                    <input type="hidden" id="nowpw" value=<%=pwd %>>
                                </dd>
                            </dl>
                            ...
                            <dl>
                                ...
                                <dd>
                                    <input type="text" class="input-group" id="phone_number"
                                           name="phone_number"
                                           value="${sessionScope.loginUser.phone_number}"/>
                                </dd>
                            </dl>
                            ...
                            <dl>
                                ...
                                <dd>
                                    <div class="form-addr">
                                        <c:choose>
                                            <c:when test="${sessionScope.loginUser.address eq 'null'}">
                                                <input type="text" class="input-group" id="address"
                                                       name="address" value="">
                                            </c:when>
                                            <c:otherwise>
                                                <input type="text" class="input-group" id="address"
                                                       name="address" value="${sessionScope.loginUser.address }">
                                            </c:otherwise>
                                        </c:choose>
                                ...
                                <dd>
                                    <div class="col-input">
                                        <label><input type="radio" name="CUST_VLID_TERM_GBCD"
                                            ...
                                            type="radio" name="CUST_VLID_TERM_GBCD" value="02"
                                            checked/><span>&nbsp;1년</span></label>
                                    </div>
                                </dd>
                            </dl>
                            ...
                            <div class="btns">
                                <button type="button" class="btn big lightgray"
                                        onclick="location.href='HyundaiServlet?command=mypage'">취소
                                </button>
                                <button type="submit" class="btn fill big black">정보변경</button>
                            </div>
                            <div class="withdrawal-area"
                                 style="text-align: right; margin-top: 430px;">
                                <p>탈퇴를 원하신다면?</p>

...
<html>
    ...
    <body>
        <div style="text-align: center;">
            <div style="display: inline-block; width: 680px; margin-bottom: 100px;">
                            ...
                            <div class="linearea" style="margin-top: 40px; text-align: left;">
                                <section class="totalmember" style="margin-left: 60px;">
                                    ...
                                    <div class="img" style="margin-top: 50px;">
                                        <a href="https://tohome.thehyundai.com/event/mk/mkf/gnrlEvnt.do?UseCache=N&evntNo=00000555"><img src="https://tohomeimage.thehyundai.com/DP/DP001/2021/12/22/160736/pc_benefit_btn2.jpg" /></a>
                                    </div>
                                    <button type="button" class="btn fill big black" onclick="not_yet()" style="width: 560px; margin-top: 40px; margin-bottom: 50px;">신규회원 및 웰컴케어 가입</button>
                                </section>
                                ...
                                <section class="member" style="margin-left: 60px; margin-top: 30px;">
                                    ...
                                    <!-- 20200420// -->
                                    <button type="button" class="btn big black" onclick="location.href='HyundaiServlet?command=joinStep2'" style="width: 560px; margin-top: 40px; margin-bottom: 35px;">일반회원가입</button>
                                    <!-- //20200420 -->
                                </section>
                            </div>
                        </div>

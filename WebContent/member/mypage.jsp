...
<style>
    ...
    .mystate-section .myinfo .memclass {
        position: relative;
        padding: 0 20px;
        width: 100%;
        height: 60px;
    ...
    .mystate-section .myinfo .memclass:after {
        content: "";
        display: block;
        clear: both;
    }

    .mystate-section .myinfo .memclass .cont {
        display: inline-block;
    }

    .mystate-section .myinfo .memclass strong {
        margin-top: 18px;
        display: inline-block;
        line-height: 1;
        color: #fff;
    ...
    .mystate-section .myinfo .memclass .name {
        margin-top: 19px;
        margin-left: 12px;
        color: #fff;
        font-size: 22px;
    ...
    .mystate-section .myinfo .memclass .pass {
        margin-top: 21px;
        margin-left: 8px;
    ...
    .mystate-section .myinfo .memclass .cont ul {
        position: absolute;
        top: 0;
        right: 20px;
    }

    .mystate-section .myinfo .memclass .cont ul:after {
        content: "";
        display: block;
        clear: both;
    }

    .mystate-section .myinfo .memclass .cont ul li {
        float: left;
    }

    .mystate-section .myinfo .memclass .cont ul li a {
        margin-left: 22px;
        padding-right: 20px;
        line-height: 60px;
        color: #fff;
    ...
    .mystate-section .myinfo .memclass .cont ul li a:after {
        margin-top: -5px;
        width: 7px;
        height: 12px;
    ...
    .mystate-section .myinfo .memclass.normal .name {
        margin-left: 0;
        color: #101010;
    }

    .mystate-section .myinfo .memclass.normal .pass {
        color: #101010;
        border-color: #101010;
    }

    .mystate-section .myinfo .memclass.normal .cont ul li a {
        color: #454545;
    }

    .mystate-section .myinfo .memclass.normal .cont ul li a:after {
        margin-top: -5px;
        width: 7px;
        height: 12px;
